window.CHAPTER_QUIZZES = [
  {
    ...
    bad: "Nesprávne. Záporné znamienko určuje smer a absolútna hodnota 0,82 znamená silný lineárny vzťah.",
    visual: `
      <div style="width:100%;max-width:500px;padding:24px;border:1px solid #304050;border-radius:16px;background:#0d1620;color:#f2f5f8;box-shadow:inset 0 0 0 1px rgba(255,255,255,.02);">
  ...
  },
  {
    ...
    correct: 1,
    ok: "Správne. Spearman pracuje s poradiami a je vhodný pri monotónnom vzťahu bez presnej linearity.",
    bad: "Nesprávne. Pri poradiach alebo ordinálnych dátach a monotónnom vzťahu je vhodnejší Spearman.",
    visual: `
      <div style="width:100%;max-width:500px;display:grid;grid-template-columns:1fr 1fr;gap:14px;">
        <div style="padding:18px;border:1px solid #304050;border-radius:14px;background:#0d1620;min-height:238px;">
          <div style="color:#58d6f3;font:800 21px Arial;margin-bottom:12px;">PEARSON</div>
          <svg viewBox="0 0 180 96" style="display:block;width:100%;height:auto;margin-bottom:12px;">
            <line x1="15" y1="8" x2="15" y2="84" stroke="#8d9aaa" stroke-width="2"/>
            <line x1="15" y1="84" x2="170" y2="84" stroke="#8d9aaa" stroke-width="2"/>
            <line x1="24" y1="74" x2="162" y2="18" stroke="#58d6f3" stroke-width="2.5"/>
            <g fill="#58d6f3"><circle cx="30" cy="76" r="4.5"/><circle cx="53" cy="67" r="4.5"/><circle cx="74" cy="56" r="4.5"/><circle cx="98" cy="50" r="4.5"/><circle cx="123" cy="36" r="4.5"/><circle cx="148" cy="24" r="4.5"/></g>
          </svg>
        ...
        <div style="padding:18px;border:1px solid #63e6be;border-radius:14px;background:rgba(99,230,190,.07);min-height:238px;box-shadow:inset 0 0 0 1px rgba(99,230,190,.15);">
          <div style="color:#63e6be;font:800 21px Arial;margin-bottom:12px;">SPEARMAN</div>
          <svg viewBox="0 0 180 96" style="display:block;width:100%;height:auto;margin-bottom:12px;">
            <line x1="15" y1="8" x2="15" y2="84" stroke="#8d9aaa" stroke-width="2"/>
            <line x1="15" y1="84" x2="170" y2="84" stroke="#8d9aaa" stroke-width="2"/>
            <path d="M26 75 C48 72, 62 64, 77 54 S110 34, 160 20" fill="none" stroke="#63e6be" stroke-width="2.5"/>
            <g fill="#63e6be"><circle cx="28" cy="75" r="4.5"/><circle cx="49" cy="69" r="4.5"/><circle cx="72" cy="58" r="4.5"/><circle cx="92" cy="44" r="4.5"/><circle cx="118" cy="33" r="4.5"/><circle cx="146" cy="24" r="4.5"/></g>
          </svg>
  ...
  },
  {
    ...
    correct: 0,
    ok: "Správne. Zo zobrazených hodnôt mimo diagonály je r = 0,653 najväčšie kladné r.",
    bad: "Nesprávne. Pozri na hodnoty mimo hlavnej diagonály; najsilnejšia kladná korelácia má najväčšie kladné r.",
    visual: `
      <div style="width:100%;max-width:500px;padding:14px;border:1px solid #304050;border-radius:16px;background:#0d1620;overflow:hidden;">
        ...
        <div style="display:grid;grid-template-columns:1.2fr repeat(4,1fr);font:700 12px Consolas,monospace;text-align:center;gap:4px;">
          <div style="padding:10px;"></div>
          <div style="padding:10px;color:#f3c969;background:rgba(243,201,105,.08);border-radius:8px;">VEK</div>
          <div style="padding:10px;color:#f3c969;background:rgba(243,201,105,.08);border-radius:8px;">TLAK</div>
          <div style="padding:10px;color:#f3c969;background:rgba(243,201,105,.08);border-radius:8px;">CHOL.</div>
          <div style="padding:10px;color:#f3c969;background:rgba(243,201,105,.08);border-radius:8px;">BMI</div>

          <div style="padding:10px;color:#58d6f3;background:rgba(88,214,243,.08);border-radius:8px;">VEK</div>
          <div style="padding:10px;color:#8d9aaa;background:rgba(255,255,255,.03);border-radius:8px;">1,000</div>
          <div style="padding:10px;background:rgba(88,214,243,.12);border-radius:8px;">0,621</div>
          <div style="padding:10px;background:#63e6be;color:#071015;font-weight:900;border-radius:8px;">0,653</div>
          <div style="padding:10px;background:rgba(255,255,255,.03);border-radius:8px;">0,210</div>

          <div style="padding:10px;color:#58d6f3;background:rgba(88,214,243,.08);border-radius:8px;">TLAK</div>
          <div style="padding:10px;background:rgba(88,214,243,.12);border-radius:8px;">0,621</div>
          <div style="padding:10px;color:#8d9aaa;background:rgba(255,255,255,.03);border-radius:8px;">1,000</div>
          <div style="padding:10px;background:rgba(255,255,255,.03);border-radius:8px;">0,310</div>
          <div style="padding:10px;background:rgba(99,230,190,.12);color:#63e6be;border-radius:8px;">0,365</div>

          <div style="padding:10px;color:#58d6f3;background:rgba(88,214,243,.08);border-radius:8px;">CHOL.</div>
          <div style="padding:10px;background:rgba(99,230,190,.12);color:#63e6be;border-radius:8px;">0,653</div>
          <div style="padding:10px;background:rgba(255,255,255,.03);border-radius:8px;">0,310</div>
          <div style="padding:10px;color:#8d9aaa;background:rgba(255,255,255,.03);border-radius:8px;">1,000</div>
          <div style="padding:10px;background:rgba(255,255,255,.03);border-radius:8px;">0,190</div>

          <div style="padding:10px;color:#58d6f3;background:rgba(88,214,243,.08);border-radius:8px;">BMI</div>
          <div style="padding:10px;background:rgba(255,255,255,.03);border-radius:8px;">0,210</div>
          <div style="padding:10px;background:rgba(99,230,190,.12);color:#63e6be;border-radius:8px;">0,365</div>
          <div style="padding:10px;background:rgba(255,255,255,.03);border-radius:8px;">0,190</div>
          <div style="padding:10px;color:#8d9aaa;background:rgba(255,255,255,.03);border-radius:8px;">1,000</div>
  ...
  },
  {
    ...
    bad: "Nesprávne. Malé p môže byť pri slabom aj silnom vzťahu; silu lineárneho vzťahu opisuje r.",
    visual: `
      <div style="width:100%;max-width:500px;display:grid;grid-template-columns:1fr 1fr;gap:14px;">
        <div style="padding:16px;border:1px solid #304050;border-radius:14px;background:#0d1620;text-align:center;">
          ...
          <svg viewBox="0 0 190 105" style="display:block;width:100%;height:auto;">
            <line x1="18" y1="8" x2="18" y2="90" stroke="#8d9aaa" stroke-width="2"/>
            <line x1="18" y1="90" x2="180" y2="90" stroke="#8d9aaa" stroke-width="2"/>
